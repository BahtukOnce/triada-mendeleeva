...
/**
 * Плашка «промах» для лучшего хода: первоубиенный был, а бонусных мест нет —
 * ход не сделан либо среди названных не оказалось чёрных.
 *
 * Раньше в таком случае блок ЛХ просто не рисовался, и карточки игр выглядели
 * разнокалиберно: у одной игры ЛХ есть, у соседней его будто и не предполагалось.
...
function achievements_catalog(): array
{
    return [
        ...
        'black3'   => ['🌘', 'Тёмная сторона', '3 раза подряд выпала чёрная роль', 'Серии'],
        'black5'   => ['🌑', 'Власть тьмы', '5 раз подряд выпала чёрная роль', 'Серии'],
        'black7'   => ['🦇', 'Дитя ночи', '7 раз подряд выпала чёрная роль', 'Серии'],
        'redrole3' => ['🌔', 'Светлая сторона', '3 раза подряд выпала красная роль', 'Серии'],
        'redrole5' => ['🌕', 'Власть света', '5 раз подряд выпала красная роль', 'Серии'],
        'redrole7' => ['🕊️', 'Дитя дня', '7 раз подряд выпала красная роль', 'Серии'],
        ...
        'elo2000'  => ['👑', 'Мастер', 'ELO 2000+', 'ELO'],
        'elo2300'  => ['🏅', 'Чемпион', 'ELO 2300+', 'ELO'],
        'elo2600'  => ['🏆', 'Легенда', 'ELO 2600+', 'ELO'],
