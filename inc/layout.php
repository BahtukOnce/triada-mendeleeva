...
function page_head(string $title, string $active = '', array $meta = []): void
{
    ...
    echo '<link rel="stylesheet" href="/assets/css/style.css?v=141">';
    ...
    if ($hasLayers) {
        echo '<a class="brand" href="/index.php"><span class="logo-anim" aria-hidden="true">'
            . '<img class="logo-face" src="/assets/img/logo_face.svg?v=7" alt="">'
            . '<img class="logo-hat" src="/assets/img/logo_hat.svg?v=7" alt="">'
...
function page_foot(): void
{
    ...
    echo '<span class="footer-links">'
       . '<a href="/app.php" style="font-size:13px;margin-right:10px;color:var(--tx2);text-decoration:none;" title="Приложение для Android">📱 Приложение</a>'
    ...
    echo '<script src="/assets/js/app.js?v=32"></script>';
    if (is_app()) {
