...
function logo_svg(int $width = 30): string
{
    ...
    return '<svg viewBox="0 0 120 140" width="' . $width . '" height="' . $h . '" aria-hidden="true" class="logo-svg">'
        ...
        . '<path d="M36 54 v9"/><circle cx="36" cy="68" r="4.5"/>'
        . '<path d="M84 54 v9"/><circle cx="84" cy="68" r="4.5"/>'
        . '<path d="M60 55 L74 63.5 V80 L60 88.5 L46 80 V63.5 Z"/>'
        . '<path d="M40 93 L60 105 L80 93"/></g>'
        . '<path d="M26 46 Q60 60 94 46 Q90 38 82 35 Q82 18 70 13 Q60 9 50 13 Q38 18 38 35 Q30 38 26 46 Z" fill="currentColor"/>'
        . '<path d="M38 35 Q60 44 82 35 L82 41 Q60 50 38 41 Z" fill="#e8332a"/>'
        . '<path d="M42 112 L58 118.5 L42 125 Q39 118.5 42 112 Z" fill="currentColor"/>'
        . '<path d="M78 112 L62 118.5 L78 125 Q81 118.5 78 112 Z" fill="currentColor"/>'
        . '<rect x="56" y="112.5" width="8" height="12" rx="2" fill="#e8332a"/></svg>';
}
