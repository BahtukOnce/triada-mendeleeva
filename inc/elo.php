...
const ELO_K = 220.0;         // размах: сильные игроки дотягивают примерно до 3000
const ELO_DIV = 2500.0;      // ширина логистики (было 400): разрыв не «насыщается», топ продолжает расти
