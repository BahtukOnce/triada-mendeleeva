...
page_head('Главная', 'index', [
    'title_tag'   => 'Триада Менделеева — клуб спортивной мафии РХТУ им. Д. И. Менделеева',
    'description' => 'Официальный сайт клуба спортивной мафии «Триада Менделеева» (РХТУ им. Д. И. Менделеева): расписание игровых вечеров, турниры, клубный рейтинг ELO и подробная статистика каждого игрока.',
    'url'         => '/',
]);
?>
...
<div class="grid-2" style="align-items:stretch;">
  ...
  <div class="card" style="overflow-x:auto;">
    ...
    <table class="tbl row-link">
      ...
      <?php $mp = current_player(); $mePid = $mp ? (int)$mp['id'] : 0; $pos = 0; foreach ($top5 as $t5): $pos++;
          $medal = $pos === 1 ? '🥇' : ($pos === 2 ? '🥈' : ($pos === 3 ? '🥉' : ''));
          $isMe = $mePid && (int)$t5['player_id'] === $mePid;
          $g = (int)$t5['games'];
