...
// Только админу, заму и руководителю (решение руководителя): это инструмент «никого не
// забыть поздравить», а даты рождения — личные данные, рядовым участникам список не нужен.
// В профиле игрока дата видна без года, здесь — так же.
