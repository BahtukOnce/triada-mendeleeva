...
if ($dbok) {
    $awTop = awards_top();
    echo '<h2 style="margin:20px 0 4px;">Награды клуба</h2>';
    echo '<p style="color:var(--tx2);font-size:13px;margin:0 0 6px;">Ступенчатые награды: у каждой показан обладатель с наивысшей степенью.</p>';
...
// ── Особые достижения ──
echo '<h2 style="margin:20px 0 4px;">Особые достижения</h2>';
